                ...
                <div class="container product pillbox">
                    <div class="row">
                        <div class="col-lg-6 col-md-6 product-slider-inner">
                            <h2 class="header2a text-blue">SonyXperia&reg; M</h2>
                            <p class="lead-summary">The only smartphone assembled in the U.S.A</p>
                            <div class="device-sliders">
                                <div class="image-preview"><img id="mainProductImage" src='images/products/sony_xperiam.jpg' data-zoom-image="images/products/sony_xperiam.jpg" /></div>
                                <div id="productImageGallery" class="owl-carousel">
                                    <div class="item"><a href="#" data-image="images/products/sony_xperiam.jpg" data-zoom-image="images/products/sony_xperiam.jpg"><img src="images/products/thumb_xperiam_1.jpg" alt="iPhone 5s" /></a></div>
                                    <div class="item"><a href="#" data-image="images/products/sony_xperiam.jpg" data-zoom-image="images/products/sony_xperiam.jpg"><img src="images/products/thumb_xperiam_2.jpg" alt="iPhone 5s" /></a></div>
                                    <div class="item"><a href="#" data-image="images/products/sony_xperiam.jpg" data-zoom-image="images/products/sony_xperiam.jpg"><img src="images/products/thumb_xperiam_3.jpg" alt="iPhone 5s" /></a></div>
                                    <div class="item"><a href="#" data-image="images/products/sony_xperiam.jpg" data-zoom-image="images/products/sony_xperiam.jpg"><img src="images/products/thumb_xperiam_1.jpg" alt="iPhone 5s" /></a></div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="row"> 
                                        <div class="col-md-6">
                                            ...
                                            <ul class="specification-lists">
                                                <li>Android&trade; 4.3 (Jelly Bean) OS</li>
                                                <li>4" TFT display</li> 
                                        ...
                                        <div class="col-md-6 text-right pull-right-extreme"><img src="images/products/spec_xperiam_1.jpg" alt="MotoG" /><br/><br/></div>
                                        <div class="clearfix"></div>
                                        <div class="col-md-4 col-md-offset-4"><hr/><br/><br/><br/></div>
                                        <div class="clearfix"></div>
                                        <div class="col-md-7 pull-left-extreme text-left"><img src="images/products/spec_xperiam_2.jpg" alt="MotoG" /></div>
                                        <div class="col-md-5 text-left pull-right">
