                ...
                <div class="container product pillbox">
                    <div class="row">
                        <div class="col-lg-6 col-md-6 product-slider-inner">
                            <h2 class="header2a text-blue">Samsung Galaxy Ace II</h2>
                            <p class="lead-summary">The only smartphone assembled in the U.S.A</p>
                            <div class="device-sliders">
                                <div class="image-preview"><img id="mainProductImage" src='images/products/samsung_galaxyace2.jpg' data-zoom-image="images/products/samsung_galaxyace2.jpg" /></div>
                                <div id="productImageGallery" class="owl-carousel">
                                    <div class="item"><a href="#" data-image="images/products/samsung_galaxyace2.jpg" data-zoom-image="images/products/samsung_galaxyace2.jpg"><img src="images/products/thumb_galaxyace2_1.jpg" alt="iPhone 5s" /></a></div>
                                    <div class="item"><a href="#" data-image="images/products/samsung_galaxyace2.jpg" data-zoom-image="images/products/samsung_galaxyace2.jpg"><img src="images/products/thumb_galaxyace2_2.jpg" alt="iPhone 5s" /></a></div>
                                    <div class="item"><a href="#" data-image="images/products/samsung_galaxyace2.jpg" data-zoom-image="images/products/samsung_galaxyace2.jpg"><img src="images/products/thumb_galaxyace2_3.jpg" alt="iPhone 5s" /></a></div>
                                    <div class="item"><a href="#" data-image="images/products/samsung_galaxyace2.jpg" data-zoom-image="images/products/samsung_galaxyace2.jpg"><img src="images/products/thumb_galaxyace2_1.jpg" alt="iPhone 5s" /></a></div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <ul class="specification-lists">
                                                <li>Android&trade; 4.0.4 (Ice Cream Sandwich) OS</li>
                                                <li>8 megapixel camera with 16:9 aspect ratio</li>
                                                <li>4.8" AMOLED (RGB) / HD 720p</li>
                                                <li>1.5 GHz Advanced Dual-Core Processor</li>
                                            </ul>
                                            <br/>
                                            <br/>                                            
                                        </div>
                                        <div class="col-md-6 pull-right-extreme text-right"><img src="images/products/spec_galaxyace2_1.jpg" alt="MotoG" /><br/><br/><br/><br/></div>
                                        <div class="clearfix"></div>
                                        <div class="col-md-4 col-md-offset-4"><hr/><br/><br/><br/></div>
                                        <div class="clearfix"></div>   
                                        <div class="col-md-8 pull-left-extreme"><img src="images/products/spec_galaxyace2_2.jpg" alt="MotoG" /></div>
                                        <div class="col-md-4">
                                            <h5 class="featurette-heading">Easier to Organize your stuff</h5>
                                            <p>Introducing a better way to get your notifications. It's everything you want to know, when you want to know it. Delivered discreetly to your screen. So you don't have to be that person always checking your phone.</p>
                                            <p>Introducing a better way to get your notifications. It's everything you want to know, when you want to know it. Delivered discreetly to your screen. So you don't have to be that person always checking your phone.</p>
                                            <br/>
                                            <br/>
                                        </div>
