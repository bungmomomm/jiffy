                ...
                <div class="container product pillbox">
                    <div class="row">
                        <div class="col-lg-6 col-md-6 product-slider-inner">
                            <h2 class="header2a text-blue">LG Nexus 5</h2>
                            <p class="lead-summary">The only smartphone assembled in the U.S.A</p>
                            <div class="device-sliders">
                                <div class="image-preview"><img id="mainProductImage" src='images/products/lg_nexus5.jpg' data-zoom-image="images/products/lg_nexus5.jpg" /></div>
                                <div id="productImageGallery" class="owl-carousel">
                                    <div class="item"><a href="#" data-image="images/products/lg_nexus5.jpg" data-zoom-image="images/products/lg_nexus5.jpg"><img src="images/products/thumb_nexus5_1.jpg" alt="iPhone 5s" /></a></div>
                                    <div class="item"><a href="#" data-image="images/products/lg_nexus5.jpg" data-zoom-image="images/products/lg_nexus5.jpg"><img src="images/products/thumb_nexus5_2.jpg" alt="iPhone 5s" /></a></div>
                                    <div class="item"><a href="#" data-image="images/products/lg_nexus5.jpg" data-zoom-image="images/products/lg_nexus5.jpg"><img src="images/products/thumb_nexus5_3.jpg" alt="iPhone 5s" /></a></div>
                                    <div class="item"><a href="#" data-image="images/products/lg_nexus5.jpg" data-zoom-image="images/products/lg_nexus5.jpg"><img src="images/products/thumb_nexus5_1.jpg" alt="iPhone 5s" /></a></div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <ul class="specification-lists">
                                                <li>Android&trade; 4.4 (KitKat) OS</li>
                                                <li>10 megapixel camera with 16:9 aspect ratio</li>
                                                <li>4.7" AMOLED (RGB) / HD 720p</li>
                                                <li>Snapdragon S4 Pro, 1.7GHz Dual-Core Krait CPU, quad-core Adreno 320 GPU</li>
                                            </ul>
                                            <br/>
                                            <br/>                                            
                                        </div>
                                        <div class="col-md-6 pull-right-extreme text-right"><img src="images/products/spec_nexus5_1.jpg" alt="MotoG" /><br/><br/><br/><br/></div>
                                        <div class="clearfix"></div>
                                        <div class="col-md-4 col-md-offset-4"><hr/><br/><br/><br/></div>
                                        <div class="clearfix"></div>   
                                        <div class="col-md-6 col-md-offset-3">
                                            <h5 class="featurette-heading text-center">The updates you need at a glance</h5>
                                        ...
                                        <div class="clearfix"></div>
                                        <div class="col-md-12 col-md-offset text-center"><img src="images/products/spec_nexus5_2.jpg" alt="MotoG" /></div>
