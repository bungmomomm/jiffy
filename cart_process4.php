        ...
        <div class="tab-cart-process">
            <ul>
                <li class="checked">
                    <div class="checked">
                        <a href="#">Add Device</a>
                        <div class="device-added">iPhone 5S 16GB</div>
                    </div>
                </li>
                <li class="checked">
                    <div class="checked">
                        <a href="#">Add Plan</a>
                        <div class="device-added">Jiffy Mobile 1GB</div>
                    </div>
                </li>
                <li class="checked">
                    <div class="checked">
                        <a href="#">Add Service</a>
                        <div class="device-added">Jiffy Mobile Product</div>
                    </div>
                </li>
                <li class="checked">
                    <div class="checked">
                        <a href="#">Add More Option</a>
                        <div class="device-added">Headset Full</div>
                    </div>
                </li>
                <li class="active"><a href="#">5. Checkout</a></li>
            </ul>
