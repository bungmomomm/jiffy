                ...
                <div class="container product pillbox">
                    <div class="row">
                        <div class="col-lg-6 col-md-6 product-slider-inner">
                            <h2 class="header2a text-blue">iPhone 5S</h2>
                            <p class="lead-summary">You are more powerfull than you think</p>
                            <div class="device-sliders">
                                <div class="image-preview"><img id="mainProductImage" src='images/products/apple_iphone5s.jpg' data-zoom-image="images/products/apple_iphone5s.jpg" /></div>
                                <div id="productImageGallery" class="owl-carousel">
                                    <div class="item"><a href="#" data-image="images/products/apple_iphone5s.jpg" data-zoom-image="images/products/apple_iphone5s.jpg"><img src="images/products/thumb_iphone5s_1.jpg" alt="iPhone 5s" /></a></div>
                                    <div class="item"><a href="#" data-image="images/products/apple_iphone5s.jpg" data-zoom-image="images/products/apple_iphone5s.jpg"><img src="images/products/thumb_iphone5s_2.jpg" alt="iPhone 5s" /></a></div>
                                    <div class="item"><a href="#" data-image="images/products/apple_iphone5s.jpg" data-zoom-image="images/products/apple_iphone5s.jpg"><img src="images/products/thumb_iphone5s_3.jpg" alt="iPhone 5s" /></a></div>
                                    <div class="item"><a href="#" data-image="images/products/apple_iphone5s.jpg" data-zoom-image="images/products/apple_iphone5s.jpg"><img src="images/products/thumb_iphone5s_1.jpg" alt="iPhone 5s" /></a></div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="apple iphone-5c overview">
                                    <div class="row">
                                        <div class="col-md-6 col-xs-7">
                                            <h5 class="featurette-heading">You are powerful than you think</h5>
                                            <p>You have the power to create, shape, and share your life. The power to do everyday things in extraordinary ways, and to do extraordinary things every day. With iPhone 5s, you’re more powerful than you think.</p>
                                            <br/>
                                        ...
                                        <div class="col-md-6 col-xs-5"><img class="img-responsive" src="images/products/spec_iphone5s_1.jpg" alt="Apple iPhone 5S" /></div>
                                        <div class="clearfix"></div>
                                        <div class="col-md-4 col-md-offset-4"><hr/><br/><br/><br/></div>
                                        <div class="clearfix"></div>   
                                        <div class="col-md-7 col-xs-7 pull-left-extreme"><img class="img-responsive" src="images/products/spec_iphone5s_2.jpg" alt="Apple iPhone 5c" /></div>
                                        <div class="col-md-5 col-xs-5 pull-right">
                                            <h5 class="featurette-heading text-right">Forward Thinking</h5>
                                            <p class=" text-right">iPhone 5s is purposefully imagined. Meticulously considered. Precision crafted. It’s not just a product of what’s technologically possible. But what’s technologically useful. It’s not just what’s next. But what should be next.</p>
                                            <br/>
                                        </div>
                                        <div class="clearfix"></div>
                                    </div>
