                ...
                <div class="container product pillbox">
                    <div class="row">
                        <div class="col-lg-6 col-md-6 product-slider-inner">
                            <h2 class="header2a text-blue">Motorola Moto G</h2>
                            <p class="lead-summary">The only smartphone assembled in the U.S.A</p>
                            <div class="device-sliders">
                                <div class="image-preview"><img id="mainProductImage" src='images/products/motorola_motog.jpg' data-zoom-image="images/products/motorola_motog.jpg" /></div>
                                <div id="productImageGallery" class="owl-carousel">
                                    <div class="item"><a href="#" data-image="images/products/motorola_motog.jpg" data-zoom-image="images/products/motorola_motog.jpg"><img src="images/products/thumb_motog_1.jpg" alt="iPhone 5s" /></a></div>
                                    <div class="item"><a href="#" data-image="images/products/motorola_motog.jpg" data-zoom-image="images/products/motorola_motog.jpg"><img src="images/products/thumb_motog_2.jpg" alt="iPhone 5s" /></a></div>
                                    <div class="item"><a href="#" data-image="images/products/motorola_motog.jpg" data-zoom-image="images/products/motorola_motog.jpg"><img src="images/products/thumb_motog_3.jpg" alt="iPhone 5s" /></a></div>
                                    <div class="item"><a href="#" data-image="images/products/motorola_motog.jpg" data-zoom-image="images/products/motorola_motog.jpg"><img src="images/products/thumb_motog_1.jpg" alt="iPhone 5s" /></a></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="tab-content">
                            <div role="tabpanel" class="tab-pane active" id="overview">
                                ...
                                <div class="apple iphone-5c overview">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <h5 class="featurette-heading">Stunning 4.5" HD display. Exceptional price</h5>
                                            <p>What you’ll notice first about Moto G is the sharp HD display. Its edge-to-edge display stretches to all four corners of the phone. Watch, read and browse on a big, brilliant display. You'll get a sharp picture and then some.</p>
                                            <br/>
                                        ...
                                        <div class="col-md-6 pull-right-extreme text-right"><img src="images/products/spec_motog_1.jpg" alt="MotoG" /></div>
                                        <div class="clearfix"></div>
                                        <div class="col-md-4 col-md-offset-4"><hr/><br/><br/><br/></div>
                                        <div class="clearfix"></div>   
                                        <div class="col-md-7 pull-left-extreme"><img src="images/products/spec_motog_2.jpg" alt="MotoG" /></div>
                                        <div class="col-md-5 pull-right">
                                            <h5 class="featurette-heading text-right">Free storage</h5>
                                            <p class=" text-right">Moto G owners (non-4G LTE versions) get an extra 50GB of Google Drive storage free* for two years to safely keep and share photos, documents and other files (that's on top of the standard 15GB). </p>
                                            <br/>
                                        </div>
                                        <div class="clearfix"></div>
                                    </div>
