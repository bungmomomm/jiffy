                ...
                <div class="container product pillbox">
                    <div class="row">
                        <div class="col-lg-6 col-md-6 product-slider-inner">
                            <h2 class="header2a text-blue">Samsung Galaxy S5</h2>
                            <p class="lead-summary">The only smartphone assembled in the U.S.A</p>
                            <div class="device-sliders">
                                <div class="image-preview"><img id="mainProductImage" src='images/products/samsung_galaxys5.jpg' data-zoom-image="images/products/samsung_galaxys5.jpg" /></div>
                                <div id="productImageGallery" class="owl-carousel">
                                    <div class="item"><a href="#" data-image="images/products/samsung_galaxys5.jpg" data-zoom-image="images/products/samsung_galaxys5.jpg"><img src="images/products/thumb_galaxys5_1.jpg" alt="iPhone 5s" /></a></div>
                                    <div class="item"><a href="#" data-image="images/products/samsung_galaxys5.jpg" data-zoom-image="images/products/samsung_galaxys5.jpg"><img src="images/products/thumb_galaxys5_2.jpg" alt="iPhone 5s" /></a></div>
                                    <div class="item"><a href="#" data-image="images/products/samsung_galaxys5.jpg" data-zoom-image="images/products/samsung_galaxys5.jpg"><img src="images/products/thumb_galaxys5_3.jpg" alt="iPhone 5s" /></a></div>
                                    <div class="item"><a href="#" data-image="images/products/samsung_galaxys5.jpg" data-zoom-image="images/products/samsung_galaxys5.jpg"><img src="images/products/thumb_galaxys5_1.jpg" alt="iPhone 5s" /></a></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <ul id="productTab" class="product-tabs clearfix" role="tablist">
                            <li role="overview" class="active col-md-4 col-xs-4 col-xs-4"><a href="#overview" aria-controls="home" role="tab" data-toggle="tab">Overview</a></li>
                            <li role="specification" class="col-md-4 col-xs-4 col-xs-4"><a href="#specification" aria-controls="profile" role="tab" data-toggle="tab">Specification</a></li>
                            <li role="inthebox" class="col-md-4 col-xs-4 col-xs-4"><a href="#inthebox" aria-controls="messages" role="tab" data-toggle="tab">In the Box</a></li>
                        </ul>
                        <div class="clearfix"></div>
                        <!-- Tab panes -->
                        <div class="tab-content">
                            <div role="tabpanel" class="tab-pane active" id="overview">
                                ...
                                <div class="apple iphone-5c overview">
                                    <div class="row">                                        
                                        <div class="col-md-6 col-xs-5 text-left pull-left-extreme"><img class="img-responsive" src="images/products/spec_galaxys5_1.jpg" alt="MotoG" /><br/><br/></div>
                                        <div class="col-md-6 col-xs-7">
                                            <h5 class="featurette-heading">Innovative than ever</h5>
                                            <p>Moto X is ready when you are. It responds to your voice. No touching necessary. Twist your wrist twice, it becomes your camera. Information quietly appears on the screeen. It doesn't interrupt and it's battery friendly</p>
                                            <br/>
                                            <h5 class="featurette-heading">Specification</h5>
                                            <ul class="specification-lists">
                                                <li>Android&trade; 4.2.2 (Jelly Bean) OS</li>
                                                <li>16 megapixel camera</li>
                                                <li>5.1" Full HD Super AMOLED display</li>                                                                                                
                                                <li>2.5 GHz Quad-Core Application Processor</li>
                                            </ul>
                                            <br/>
                                            <br/>                                            
                                        </div>
                                        ...
                                        <div class="col-md-5 col-xs-6 pull-left">
                                            <h5 class="featurette-heading text-left">Easier to Organize your stuff</h5>
                                            <p class="text-left">Introducing a better way to get your notifications. It's everything you want to know, when you want to know it. Delivered discreetly to your screen. So you don't have to be that person always checking your phone.</p>
                                            <p class="text-left">Introducing a better way to get your notifications. It's everything you want to know, when you want to know it. Delivered discreetly to your screen. So you don't have to be that person always checking your phone.</p>
                                            <br/>
                                            <br/>
                                        </div>
                                        <div class="col-md-7 col-xs-6 pull-right-extreme text-right"><img class="img-responsive" src="images/products/spec_galaxys5_2.jpg" alt="MotoG" /></div>
