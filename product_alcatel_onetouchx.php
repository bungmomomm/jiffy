                ...
                <div class="container product pillbox">
                    <div class="row">
                        <div class="col-lg-6 col-md-6 product-slider-inner">
                            <h2 class="header2a text-blue">Alcatel OneTouchIdol&trade; X</h2>
                            <p class="lead-summary">The only smartphone assembled in the U.S.A</p>
                            <div class="device-sliders">
                                <div class="image-preview"><img id="mainProductImage" src='images/products/alcatel_onetouch_x.jpg' data-zoom-image="images/products/alcatel_onetouch_x.jpg" /></div>
                                <div id="productImageGallery" class="owl-carousel">
                                    <div class="item"><a href="#" data-image="images/products/alcatel_onetouch_x.jpg" data-zoom-image="images/products/alcatel_onetouch_x.jpg"><img src="images/products/thumb_alcatel_1.jpg" alt="iPhone 5s" /></a></div>
                                    <div class="item"><a href="#" data-image="images/products/alcatel_onetouch_x.jpg" data-zoom-image="images/products/alcatel_onetouch_x.jpg"><img src="images/products/thumb_alcatel_2.jpg" alt="iPhone 5s" /></a></div>
                                    <div class="item"><a href="#" data-image="images/products/alcatel_onetouch_x.jpg" data-zoom-image="images/products/alcatel_onetouch_x.jpg"><img src="images/products/thumb_alcatel_3.jpg" alt="iPhone 5s" /></a></div>
                                    <div class="item"><a href="#" data-image="images/products/alcatel_onetouch_x.jpg" data-zoom-image="images/products/alcatel_onetouch_x.jpg"><img src="images/products/thumb_alcatel_1.jpg" alt="iPhone 5s" /></a></div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <ul class="specification-lists">
                                                <li>Android&trade; 4.2 (Jelly Bean) OS</li>                                                
                                                <li>5" Full HD IPS Display</li>
                                        ...
                                        <div class="col-md-6 text-right"><img class="img-responsive" src="images/products/spec_alcatel_1.jpg" alt="MotoG" /><br/><br/><br/><br/></div>
                                        <div class="clearfix"></div>
                                        <div class="col-md-4 col-md-offset-4"><hr/><br/><br/><br/></div>
                                        <div class="clearfix"></div>   
                                        <div class="col-md-7 col-xs-6 pull-left-extreme text-left"><img class="img-responsive" src="images/products/spec_alcatel_2.jpg" alt="MotoG" /></div>
