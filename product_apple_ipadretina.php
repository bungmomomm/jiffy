                ...
                <div class="container product pillbox">
                    <div class="row">
                        <div class="col-lg-6 col-md-6 product-slider-inner">
                            <h2 class="header2a text-blue">iPad Retina Display</h2>
                            <p class="lead-summary">Smart tablet for active people</p>
                            <div class="device-sliders">
                                <div class="image-preview"><img id="mainProductImage" src='images/products/apple_ipad_retina.jpg' data-zoom-image="images/products/apple_ipad_retina.jpg" /></div>
                                <div id="productImageGallery" class="owl-carousel">
                                    <div class="item"><a href="#" data-image="images/products/apple_ipad_retina.jpg" data-zoom-image="images/products/apple_ipad_retina.jpg"><img src="images/products/thumb_ipadmini_1.jpg" alt="iPhone 5s" /></a></div>
                                    <div class="item"><a href="#" data-image="images/products/apple_ipad_retina.jpg" data-zoom-image="images/products/apple_ipad_retina.jpg"><img src="images/products/thumb_ipadmini_2.jpg" alt="iPhone 5s" /></a></div>
                                    <div class="item"><a href="#" data-image="images/products/apple_ipad_retina.jpg" data-zoom-image="images/products/apple_ipad_retina.jpg"><img src="images/products/thumb_ipadmini_3.jpg" alt="iPhone 5s" /></a></div>
                                    <div class="item"><a href="#" data-image="images/products/apple_ipad_retina.jpg" data-zoom-image="images/products/apple_ipad_retina.jpg"><img src="images/products/thumb_ipadmini_1.jpg" alt="iPhone 5s" /></a></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="tab-content">
                            <div role="tabpanel" class="tab-pane active" id="overview">
                                ...
                                <div class="apple iphone-5c overview">
                                    <div class="row">
                                        <div class="col-md-7 pull-left-extreme text-left"><img src="images/products/spec_ipadretina_1.jpg" alt="MotoG" /></div>
                                        <div class="col-md-5">
                                        ...
                                        <div class="clearfix"></div>
                                        <div class="col-md-4 col-md-offset-4"><hr class="margin-top-0"/><br/><br/><br/></div>
                                        <div class="clearfix"></div>                                           
                                        ...
                                        <div class="col-md-7 text-right"><img src="images/products/spec_ipadretina_2.jpg" alt="iPad Retina" /></div>
                                        <div class="clearfix"></div>
                                    </div>
                                </div>
                            </div>
