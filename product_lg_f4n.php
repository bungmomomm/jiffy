                ...
                <div class="container product pillbox">
                    <div class="row">
                        <div class="col-lg-6 col-md-6 product-slider-inner">
                            <h2 class="header2a text-blue">LG F4n</h2>
                            <p class="lead-summary">The only smartphone assembled in the U.S.A</p>
                            <div class="device-sliders">
                                <div class="image-preview"><img id="mainProductImage" src='images/products/lg_f4n.jpg' data-zoom-image="images/products/lg_f4n.jpg" /></div>
                                <div id="productImageGallery" class="owl-carousel">
                                    <div class="item"><a href="#" data-image="images/products/lg_f4n.jpg" data-zoom-image="images/products/lg_f4n.jpg"><img src="images/products/thumb_lgf4n_1.jpg" alt="iPhone 5s" /></a></div>
                                    <div class="item"><a href="#" data-image="images/products/lg_f4n.jpg" data-zoom-image="images/products/lg_f4n.jpg"><img src="images/products/thumb_lgf4n_2.jpg" alt="iPhone 5s" /></a></div>
                                    <div class="item"><a href="#" data-image="images/products/lg_f4n.jpg" data-zoom-image="images/products/lg_f4n.jpg"><img src="images/products/thumb_lgf4n_3.jpg" alt="iPhone 5s" /></a></div>
                                    <div class="item"><a href="#" data-image="images/products/lg_f4n.jpg" data-zoom-image="images/products/lg_f4n.jpg"><img src="images/products/thumb_lgf4n_1.jpg" alt="iPhone 5s" /></a></div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="apple iphone-5c overview">
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <p>LG F4n is ready when you are. It responds to your voice. No touching necessary. Twist your wrist twice, it becomes your camera. Information quietly appears on the screeen. It doesn't interrupt and it's battery friendly</p>
                                            <br/>
                                            <h5 class="featurette-heading">Specification</h5>
                                            <ul class="specification-lists">
                                                <li>LG Proprietary OS</li>
                                                <li>2.2" QCIF TFT display</li>
                                                <li>1.3 megapixel camera</li>
                                            </ul>
                                            <br/>
                                            <br/>                                            
                                        </div>
                                        <div class="col-md-6 pull-right-extreme text-right"><img src="images/products/spec_lgf4n_1.jpg" alt="MotoG" /><br/><br/><br/><br/></div>
                                        <div class="clearfix"></div>
                                    </div>
                                </div>
                            </div>
