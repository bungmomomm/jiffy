                ...
                <div class="container product pillbox">
                    <div class="row">
                        <div class="col-lg-6 col-md-6 product-slider-inner">
                            <h2 class="header2a text-blue">Samsung Galaxy Note 3</h2>
                            <p class="lead-summary">The only smartphone assembled in the U.S.A</p>
                            <div class="device-sliders">
                                <div class="image-preview"><img id="mainProductImage" src='images/products/samsung_galaxynote3.jpg' data-zoom-image="images/products/samsung_galaxynote3.jpg" /></div>
                                <div id="productImageGallery" class="owl-carousel">
                                    <div class="item"><a href="#" data-image="images/products/samsung_galaxynote3.jpg" data-zoom-image="images/products/samsung_galaxynote3.jpg"><img src="images/products/thumb_galaxynote3_1.jpg" alt="iPhone 5s" /></a></div>
                                    <div class="item"><a href="#" data-image="images/products/samsung_galaxynote3.jpg" data-zoom-image="images/products/samsung_galaxynote3.jpg"><img src="images/products/thumb_galaxynote3_2.jpg" alt="iPhone 5s" /></a></div>
                                    <div class="item"><a href="#" data-image="images/products/samsung_galaxynote3.jpg" data-zoom-image="images/products/samsung_galaxynote3.jpg"><img src="images/products/thumb_galaxynote3_3.jpg" alt="iPhone 5s" /></a></div>
                                    <div class="item"><a href="#" data-image="images/products/samsung_galaxynote3.jpg" data-zoom-image="images/products/samsung_galaxynote3.jpg"><img src="images/products/thumb_galaxynote3_1.jpg" alt="iPhone 5s" /></a></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="tab-content">
                            <div role="tabpanel" class="tab-pane active" id="overview">
                                ...
                                <div class="apple iphone-5c overview">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <h5 class="featurette-heading">The only smartphone assembled in the U.S.A</h5>
                                            ...
                                            <ul class="specification-lists">
                                                ...
                                                <li>5.7" Full HD Super AMOLED display</li>
                                                <li>2.3 GHz CPU Speed</li>
                                            </ul>
                                            <br/>
                                            <br/>                                            
                                        </div>
                                        <div class="col-md-6 pull-right-extreme text-right"><img src="images/products/spec_galaxynote3_1.jpg" alt="MotoG" /><br/><br/><br/><br/></div>
                                        <div class="clearfix"></div>
                                        ...
                                        <div class="clearfix"></div>
                                        <div class="col-md-12 col-md-offset text-center"><img src="images/products/spec_galaxynote3_2.jpg" alt="MotoG" /></div>
