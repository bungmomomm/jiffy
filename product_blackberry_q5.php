                ...
                <div class="container product pillbox">
                    <div class="row">
                        <div class="col-lg-6 col-md-6 product-slider-inner">
                            <h2 class="header2a text-blue">BlackBerry&copy;Q5</h2>
                            <p class="lead-summary">The only smartphone assembled in the U.S.A</p>
                            <div class="device-sliders">
                                <div class="image-preview"><img id="mainProductImage" src='images/products/blackberry_q5.jpg' data-zoom-image="images/products/blackberry_q5.jpg" /></div>
                                <div id="productImageGallery" class="owl-carousel">
                                    <div class="item"><a href="#" data-image="images/products/blackberry_q5.jpg" data-zoom-image="images/products/blackberry_q5.jpg"><img src="images/products/thumb_bbq5_1.jpg" alt="iPhone 5s" /></a></div>
                                    <div class="item"><a href="#" data-image="images/products/blackberry_q5.jpg" data-zoom-image="images/products/blackberry_q5.jpg"><img src="images/products/thumb_bbq5_2.jpg" alt="iPhone 5s" /></a></div>
                                    <div class="item"><a href="#" data-image="images/products/blackberry_q5.jpg" data-zoom-image="images/products/blackberry_q5.jpg"><img src="images/products/thumb_bbq5_3.jpg" alt="iPhone 5s" /></a></div>
                                    <div class="item"><a href="#" data-image="images/products/blackberry_q5.jpg" data-zoom-image="images/products/blackberry_q5.jpg"><img src="images/products/thumb_bbq5_1.jpg" alt="iPhone 5s" /></a></div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-xs-6">
                                            ...
                                            <ul class="specification-lists">
                                                <li>BlackBerry&copy; Keyboard</li>    
                                                <li>BlackBerry&copy; World</li> 
                                                <li>BlackBerry&copy; Hub</li>                                             
                                                <li>Time Shift mode and Story Maker</li>
                                                <li>BBM&trade; Video with Screen Share</li>
                                            </ul>
                                            <br/>
                                            <br/>                                            
                                        </div>
                                        <div class="col-md-6 col-xs-6 pull-right-extreme text-right"><img class="img-responsive" src="images/products/spec_bbq5_1.jpg" alt="MotoG" /><br/><br/><br/><br/></div>
                                        <div class="clearfix"></div>
                                        <div class="col-md-4 col-md-offset-4"><hr/><br/><br/><br/></div>
                                        <div class="clearfix"></div>   
                                        <div class="col-md-6 col-md-offset-3">
                                            <h5 class="featurette-heading text-center">Take Photos Like a Pro</h5>
                                            <p class="text-center">Introducing a better way to get your notifications. It's everything you want to know, when you want to know it. Delivered discreetly to your screen. So you don't have to be that person always checking your phone.</p>
                                            <br/>
                                            <br/>
                                        </div>
                                        <div class="col-md-10 col-md-offset-1 text-center"><img class="img-responsive center-block" src="images/products/spec_bbq5_2.jpg" alt="MotoG" /></div>
                                        <div class="clearfix"></div>
                                    </div>
                                </div>
                            </div>
