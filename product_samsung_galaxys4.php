                ...
                <div class="container product pillbox">
                    <div class="row">
                        <div class="col-lg-6 col-md-6 product-slider-inner">
                            <h2 class="header2a text-blue">Samsung Galaxy S4</h2>
                            <p class="lead-summary">The only smartphone assembled in the U.S.A</p>
                            <div class="device-sliders">
                                <div class="image-preview"><img id="mainProductImage" src='images/products/samsung_galaxys4.jpg' data-zoom-image="images/products/samsung_galaxys4.jpg" /></div>
                                <div id="productImageGallery" class="owl-carousel">
                                    <div class="item"><a href="#" data-image="images/products/samsung_galaxys4.jpg" data-zoom-image="images/products/samsung_galaxys4.jpg"><img src="images/products/thumb_galaxys4_1.jpg" alt="iPhone 5s" /></a></div>
                                    <div class="item"><a href="#" data-image="images/products/samsung_galaxys4.jpg" data-zoom-image="images/products/samsung_galaxys4.jpg"><img src="images/products/thumb_galaxys4_2.jpg" alt="iPhone 5s" /></a></div>
                                    <div class="item"><a href="#" data-image="images/products/samsung_galaxys4.jpg" data-zoom-image="images/products/samsung_galaxys4.jpg"><img src="images/products/thumb_galaxys4_3.jpg" alt="iPhone 5s" /></a></div>
                                    <div class="item"><a href="#" data-image="images/products/samsung_galaxys4.jpg" data-zoom-image="images/products/samsung_galaxys4.jpg"><img src="images/products/thumb_galaxys4_1.jpg" alt="iPhone 5s" /></a></div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <ul class="specification-lists">
                                                ...
                                                <li>5" Full HD Super AMOLED display</li>
                                                <li>1.9 GHz Quad-Core Processor</li>
                                            </ul>
                                            <br/>
                                            <br/>                                            
                                        </div>
                                        <div class="col-md-6 text-right pull-right-extreme"><img src="images/products/spec_galaxys4_1.jpg" alt="MotoG" /><br/><br/><br/><br/></div>
                                        <div class="clearfix"></div>
                                        <div class="col-md-4 col-md-offset-4"><hr/><br/><br/><br/></div>
                                        <div class="clearfix"></div>
                                        <div class="col-md-7 pull-left-extreme"><img src="images/products/spec_galaxys4_2.jpg" alt="MotoG" /></div>
                                        <div class="col-md-5 pull-right text-left">
                                            <h5 class="featurette-heading text-right">Easier to Organize your stuff</h5>
                                            <p class="text-right">Introducing a better way to get your notifications. It's everything you want to know, when you want to know it. Delivered discreetly to your screen. So you don't have to be that person always checking your phone.</p>
                                            <p class="text-right">Introducing a better way to get your notifications. It's everything you want to know, when you want to know it. Delivered discreetly to your screen. So you don't have to be that person always checking your phone.</p>
                                            <br/>
                                            <br/>
                                        </div>
