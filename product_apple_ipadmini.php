                ...
                <div class="container product pillbox">
                    <div class="row">
                        <div class="col-lg-6 col-md-6 product-slider-inner">
                            <h2 class="header2a text-blue">iPad mini with Retina Display</h2>
                            <p class="lead-summary">Smart tablet for active people</p>
                            <div class="device-sliders">
                                <div class="image-preview"><img id="mainProductImage" src='images/products/apple_ipadmini_retina.jpg' data-zoom-image="images/products/apple_ipadmini_retina.jpg" /></div>
                                <div id="productImageGallery" class="owl-carousel">
                                    <div class="item"><a href="#" data-image="images/products/apple_ipadmini_retina.jpg" data-zoom-image="images/products/apple_ipadmini_retina.jpg"><img src="images/products/thumb_ipadmini_1.jpg" alt="iPhone 5s" /></a></div>
                                    <div class="item"><a href="#" data-image="images/products/apple_ipadmini_retina.jpg" data-zoom-image="images/products/apple_ipadmini_retina.jpg"><img src="images/products/thumb_ipadmini_2.jpg" alt="iPhone 5s" /></a></div>
                                    <div class="item"><a href="#" data-image="images/products/apple_ipadmini_retina.jpg" data-zoom-image="images/products/apple_ipadmini_retina.jpg"><img src="images/products/thumb_ipadmini_3.jpg" alt="iPhone 5s" /></a></div>
                                    <div class="item"><a href="#" data-image="images/products/apple_ipadmini_retina.jpg" data-zoom-image="images/products/apple_ipadmini_retina.jpg"><img src="images/products/thumb_ipadmini_1.jpg" alt="iPhone 5s" /></a></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="tab-content">
                            <div role="tabpanel" class="tab-pane active" id="overview">
                                <h4 class="sub-heading">Meet the phone that's built for your life</h4><br/><br/>
                                <div class="apple iphone-5c overview">
                                    <div class="row">
                                        <div class="col-md-7 col-xs-6 pull-left-extreme text-left"><img src="images/products/spec_ipadmini_1.jpg" alt="MotoG" class="img-responsive" /></div>
                                        <div class="col-md-5 col-xs-6">
                                            <h5 class="featurette-heading">Innovative than ever</h5>
                                            <p>iPad mini Retina is ready when you are. It responds to your voice. No touching necessary. Twist your wrist twice, it becomes your camera. Information quietly appears on the screeen. It doesn't interrupt and it's battery friendly</p>
                                            <br/>
                                            <h5 class="featurette-heading">Specification</h5>
                                            <ul class="specification-lists">
                                                <li>7.9" retina display</li>    
                                                <li>A7 chip with 64-bit architecture and M7 motion coprocessor</li> 
                                        ...
                                        <div class="clearfix"></div>
                                        <div class="col-md-10 col-md-offset-1"><hr class="margin-top-0"/><br/><br/><br/></div>
                                        <div class="clearfix"></div>                                           
                                        <div class="col-md-5 text-left">
                                            <h5 class="featurette-heading text-left">Take Photos Like a Pro</h5>
                                        ...
                                        <div class="col-md-7 text-right"><img src="images/products/spec_ipadmini_2.jpg" alt="MotoG" /><br/><br/><br/></div>
                                        <div class="clearfix"></div>
                                    </div>
                                </div>
                            </div>
