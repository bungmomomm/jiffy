                ...
                <div class="container product pillbox">
                    <div class="row">
                        <div class="col-lg-6 col-md-6 product-slider-inner">
                            <h2 class="header2a text-blue">Samsung Galaxy S4 Mini</h2>
                            <p class="lead-summary">The only smartphone assembled in the U.S.A</p>
                            <div class="device-sliders">
                                <div class="image-preview"><img id="mainProductImage" src='images/products/samsung_galaxys4mini.jpg' data-zoom-image="images/products/samsung_galaxys4mini.jpg" /></div>
                                <div id="productImageGallery" class="owl-carousel">
                                    <div class="item"><a href="#" data-image="images/products/samsung_galaxys4mini.jpg" data-zoom-image="images/products/samsung_galaxys4mini.jpg"><img src="images/products/thumb_galaxys4mini_1.jpg" alt="iPhone 5s" /></a></div>
                                    <div class="item"><a href="#" data-image="images/products/samsung_galaxys4mini.jpg" data-zoom-image="images/products/samsung_galaxys4mini.jpg"><img src="images/products/thumb_galaxys4mini_2.jpg" alt="iPhone 5s" /></a></div>
                                    <div class="item"><a href="#" data-image="images/products/samsung_galaxys4mini.jpg" data-zoom-image="images/products/samsung_galaxys4mini.jpg"><img src="images/products/thumb_galaxys4mini_3.jpg" alt="iPhone 5s" /></a></div>
                                    <div class="item"><a href="#" data-image="images/products/samsung_galaxys4mini.jpg" data-zoom-image="images/products/samsung_galaxys4mini.jpg"><img src="images/products/thumb_galaxys4mini_1.jpg" alt="iPhone 5s" /></a></div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <ul class="specification-lists">
                                                ...
                                                <li>4.3" Super AMOLED qHD display</li>
                                                <li>8 MP camera with 1.9 MP front</li>                                                
                                                <li>1.7 GHz Quad-Core Processor</li>
                                            </ul>
                                            <br/>
                                            <br/>                                            
                                        </div>
                                        <div class="col-md-6 text-right"><img src="images/products/spec_galaxys4mini_1.jpg" alt="MotoG" /><br/><br/></div>
                                        <div class="clearfix"></div>
                                        <div class="col-md-4 col-md-offset-4"><hr/><br/><br/><br/></div>
                                        <div class="clearfix"></div>
                                        <div class="col-md-7 pull-left-extreme"><img src="images/products/spec_galaxys4mini_2.jpg" alt="MotoG" /></div>
