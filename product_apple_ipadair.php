                ...
                <div class="container product pillbox">
                    <div class="row">
                        <div class="col-lg-6 col-md-6 product-slider-inner">
                            <h2 class="header2a text-blue">iPad Air</h2>
                            <p class="lead-summary">Smart tablet for active people</p>
                            <div class="device-sliders">
                                <div class="image-preview"><img id="mainProductImage" src='images/products/apple_ipadair.jpg' data-zoom-image="images/products/apple_ipadair.jpg" /></div>
                                <div id="productImageGallery" class="owl-carousel">
                                    <div class="item"><a href="#" data-image="images/products/apple_ipadair.jpg" data-zoom-image="images/products/apple_ipadair.jpg"><img src="images/products/thumb_ipadair_1.jpg" alt="iPhone 5s" /></a></div>
                                    <div class="item"><a href="#" data-image="images/products/apple_ipadair.jpg" data-zoom-image="images/products/apple_ipadair.jpg"><img src="images/products/thumb_ipadair_2.jpg" alt="iPhone 5s" /></a></div>
                                    <div class="item"><a href="#" data-image="images/products/apple_ipadair.jpg" data-zoom-image="images/products/apple_ipadair.jpg"><img src="images/products/thumb_ipadair_3.jpg" alt="iPhone 5s" /></a></div>
                                    <div class="item"><a href="#" data-image="images/products/apple_ipadair.jpg" data-zoom-image="images/products/apple_ipadair.jpg"><img src="images/products/thumb_ipadair_1.jpg" alt="iPhone 5s" /></a></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="tab-content">
                            <div role="tabpanel" class="tab-pane active" id="overview">
                                ...
                                <div class="apple iphone-5c overview">
                                    <div class="row">
                                        <div class="col-md-7 col-xs-6 pull-left-extreme text-left"><img class="img-responsive" src="images/products/spec_ipadair_1.jpg" alt="MotoG" style="padding-top: 200px;" /><br/><br/><br/><br/></div>
                                        ...
                                        <div class="clearfix"></div>
                                        <div class="col-md-8 col-md-offset-2"><hr/><br/><br/><br/></div>
                                        <div class="clearfix"></div>                                           
                                        ...
                                        <div class="col-md-8 text-right pull-right-extreme"><img src="images/products/spec_ipadair_2.jpg" alt="MotoG" /></div>
                                        <div class="clearfix"></div>
                                    </div>
                                </div>
                            </div>
