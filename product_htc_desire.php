                ...
                <div class="container product pillbox">
                    <div class="row">
                        <div class="col-lg-6 col-md-6 product-slider-inner">
                            <h2 class="header2a text-blue">HTC Desire&reg;</h2>
                            <p class="lead-summary">The only smartphone assembled in the U.S.A</p>
                            <div class="device-sliders">
                                <div class="image-preview"><img id="mainProductImage" src='images/products/htc_desire.jpg' data-zoom-image="images/products/htc_desire.jpg" /></div>
                                <div id="productImageGallery" class="owl-carousel">
                                    <div class="item"><a href="#" data-image="images/products/htc_desire.jpg" data-zoom-image="images/products/htc_desire.jpg"><img src="images/products/thumb_htcdesire_1.jpg" alt="iPhone 5s" /></a></div>
                                    <div class="item"><a href="#" data-image="images/products/htc_desire.jpg" data-zoom-image="images/products/htc_desire.jpg"><img src="images/products/thumb_htcdesire_2.jpg" alt="iPhone 5s" /></a></div>
                                    <div class="item"><a href="#" data-image="images/products/htc_desire.jpg" data-zoom-image="images/products/htc_desire.jpg"><img src="images/products/thumb_htcdesire_3.jpg" alt="iPhone 5s" /></a></div>
                                    <div class="item"><a href="#" data-image="images/products/htc_desire.jpg" data-zoom-image="images/products/htc_desire.jpg"><img src="images/products/thumb_htcdesire_1.jpg" alt="iPhone 5s" /></a></div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <ul class="specification-lists">
                                                <li>Android&trade; with HTC Sense&trade;</li>    
                                                <li>4.5" qHD display</li> 
                                                <li>5 megapixel camera</li>                                             
                                                <li>1.4GHz Qualcomm&copy; Snapdragon&trade; 400, dual-core processor</li>
                                            </ul>
                                            <br/>
                                            <br/>                                            
                                        </div>
                                        <div class="col-md-6 pull-right-extreme text-right"><img src="images/products/spec_htcdesire_1.jpg" alt="MotoG" /><br/><br/><br/><br/></div>
                                        <div class="clearfix"></div>
                                        <div class="col-md-4 col-md-offset-4"><hr/><br/><br/><br/></div>
                                        <div class="clearfix"></div>   
                                        <div class="col-md-6 text-left"><img src="images/products/spec_htcdesire_2.jpg" alt="MotoG" /></div>
